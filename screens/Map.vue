          ...
          <ul class="list-group" v-if="currentFestivals.length !== 0">
            <li v-for="one in currentFestivals" v-bind:key="one.id">
              ...
              >
                ...
                <div class="mb-0 fs-7">
                  <i class="bi bi-building"></i> {{ one.organizer }}
                </div>
                <div class="mb-0 fs-7">
                  <i class="bi bi-telephone"></i> {{ one.phoneNumber }}
                </div>
                <div class="mb-0 fs-7">
                  <i class="bi bi-calendar"></i> {{ one.startDate }} ~
                  {{ one.endDate }}
                </div>
                <a
                  v-if="one.homepageUrl"
                  :href="one.homepageUrl"
                  class="card-link"
                  target="_blank"
                  >link</a
                >
